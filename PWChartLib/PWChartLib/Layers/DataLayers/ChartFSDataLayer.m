...
//        point.y = point.y - size.height;
        ...
        CATextLayer *layer = [LayerMaker getTextLayer:string point:point font:[UIFont systemFontOfSize:10] foregroundColor:[PWChartColors colorByKey:(isCross ? kChartColorKey_TextBorderText : kChartColorKey_Text)] frame:frame];
        if (isCross) {
